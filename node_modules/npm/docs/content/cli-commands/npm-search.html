<h1 id="npm-search1">npm-search(1)</h1>

<h2 id="search-for-packages">Search for packages</h2>

<h3 id="synopsis">Synopsis</h3>

<div class="language-bash highlighter-rouge"><div class="highlight"><pre class="highlight"><code>npm search <span class="o">[</span><span class="nt">-l</span>|--long] <span class="o">[</span><span class="nt">--json</span><span class="o">]</span> <span class="o">[</span><span class="nt">--parseable</span><span class="o">]</span> <span class="o">[</span><span class="nt">--no-description</span><span class="o">]</span> <span class="o">[</span>search terms ...]
...
<p>Search the registry for packages matching the search terms. <code class="highlighter-rouge">npm search</code>
...
<p>Additionally, using the <code class="highlighter-rouge">--searchopts</code> and <code class="highlighter-rouge">--searchexclude</code> options paired with
more search terms will respectively include and exclude further patterns. The
main difference between <code class="highlighter-rouge">--searchopts</code> and the standard search terms is that the
former does not highlight results in the output and can be used for more
fine-grained filtering. Additionally, both of these can be added to <code class="highlighter-rouge">.npmrc</code> for
default search filtering behavior.</p>

<p>Search also allows targeting of maintainers in search results, by prefixing
their npm username with <code class="highlighter-rouge">=</code>.</p>

<p>If a term starts with <code class="highlighter-rouge">/</code>, then it’s interpreted as a regular expression and
supports standard JavaScript RegExp syntax. A trailing <code class="highlighter-rouge">/</code> will be ignored in
...
<p>Used as <code class="highlighter-rouge">--no-description</code>, disables search matching in package descriptions and
...
repository, <code class="highlighter-rouge">npm search</code> will default to that registry when searching. Pass a
