...
to contain a <code class="highlighter-rouge">package.json</code> file or <code class="highlighter-rouge">node_modules</code> directory, unless <code class="highlighter-rouge">-g</code> is
also specified.</p>

<p>If <code class="highlighter-rouge">-g</code> is specified, this will be the value of the global prefix. See
<a href="/cli-commands/config"><code class="highlighter-rouge">npm config</code></a> for more detail.</p>
