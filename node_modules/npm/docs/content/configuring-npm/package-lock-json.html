<h1 id="package-lockjson5">package-lock.json(5)</h1>

<h2 id="a-manifestation-of-the-manifest">A manifestation of the manifest</h2>

<h3 id="description">Description</h3>

<p><code class="highlighter-rouge">package-lock.json</code> is automatically generated for any operations where npm
modifies either the <code class="highlighter-rouge">node_modules</code> tree, or <code class="highlighter-rouge">package.json</code>. It describes the
...
<ul>
  ...
  <li>
    <p>Provide a facility for users to “time-travel” to previous states of <code class="highlighter-rouge">node_modules</code> without having to commit the directory itself.</p>
  </li>
  <li>
...
<p>One key detail about <code class="highlighter-rouge">package-lock.json</code> is that it cannot be published, and it
...
<p>If both <code class="highlighter-rouge">package-lock.json</code> and <code class="highlighter-rouge">npm-shrinkwrap.json</code> are present in the root of
a package, <code class="highlighter-rouge">package-lock.json</code> will be completely ignored.</p>
...
<p>An integer version, starting at <code class="highlighter-rouge">1</code> with the version number of this document
whose semantics were used when generating this <code class="highlighter-rouge">package-lock.json</code>.</p>
...
integrity</a> value
created from the <code class="highlighter-rouge">package.json</code>. No preprocessing of the <code class="highlighter-rouge">package.json</code> should
be done. Subresource integrity strings can be produced by modules like
<a href="https://www.npmjs.com/package/ssri"><code class="highlighter-rouge">ssri</code></a>.</p>

<h4 id="preservesymlinks">preserveSymlinks</h4>

<p>Indicates that the install was done with the environment variable
<code class="highlighter-rouge">NODE_PRESERVE_SYMLINKS</code> enabled. The installer should insist that the value of
...
<ul>
  ...
  <li>registry sources: This is a version number. (eg, <code class="highlighter-rouge">1.2.3</code>)</li>
  <li>git sources: This is a git specifier with resolved committish. (eg, <code class="highlighter-rouge">git+https://example.com/foo/bar#115311855adb0789a0466714ed48a1499ffea97e</code>)</li>
  <li>http tarball sources: This is the URL of the tarball. (eg, <code class="highlighter-rouge">https://example.com/example-1.3.0.tgz</code>)</li>
  <li>local tarball sources: This is the file URL of the tarball. (eg <code class="highlighter-rouge">file:///opt/storage/example-1.3.0.tgz</code>)</li>
  <li>local link sources: This is the file URL of the link. (eg <code class="highlighter-rouge">file:libs/our-module</code>)</li>
</ul>
...
<ul>
  ...
  <li>For registry sources, this is the <code class="highlighter-rouge">integrity</code> that the registry provided, or if one wasn’t provided the SHA1 in <code class="highlighter-rouge">shasum</code>.</li>
...
<code class="highlighter-rouge">dependencies</code> or in a level higher than us.</p>
