...
<p>Conceptually, the “input” to <a href="/cli-commands/install"><code class="highlighter-rouge">npm install</code></a> is a <a href="/configuring-npm/package-json">package.json</a>, while its
